...
function is31Flavors(flavorTest){

    /*code here*/
    if(flavorTest.length === 31) {
        console.log(true);
    } else {
        console.log(false + flavorTest.length);
    }
}
...
function addFlavor(flavor, flavorArray){
...
function getFlavorByIndex(array, indexOf){
...
function removeFlavorByName(array, flavorName){
    ...
    /*code here*/
    let flavorIndex = array.indexOf(flavorName);
    array.splice(flavorIndex);
...
copy(copyOgArr, originalFlavors);
...
function filterByWord(arr, arrString) {
    let stringArray = [];
    for (let i = 0; i < arr.length; i++) {
        if(arr[i].includes(arrString)) {
